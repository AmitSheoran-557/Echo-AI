...
const Hero = () => {
    return (
        <div className='bg-hero-bg bg-cover bg-no-repeat bg-center relative lg:pb-[260px] bg-black max-xl:px-4' id='Benefits'>
            ...
            <Header />
            <div className="container mx-auto max-w-[1140px] xl:pt-[166px] lg:pt-32 md:pt-24 sm:pt-16 pt-10">
                <div className="flex flex-wrap">
                    <div className="lg:w-7/12 w-full">
                        <div className='flex flex-col'>
                            <h1 className='lg:mb-6 sm:mb-4 mb-3 font-bold xl:text-7xl lg:text-5xl text-4xl text-center xl:min-w-[685px] lg:max-w-2xl text-white !leading-[120%]'>Innovate, Automate, Accelerate </h1>
